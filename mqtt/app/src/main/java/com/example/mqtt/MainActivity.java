...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mqttAndroidClient = new MqttAndroidClient(this,  "tcp://" + "192.168.0.16" + ":1883", MqttClient.generateClientId());
        ...
        try {
            ...
            token.setActionCallback(new IMqttActionListener() {
                ...
                public void onSuccess(IMqttToken asyncActionToken) {
                    ...
                    try {
                        mqttAndroidClient.subscribe("otpbox", 0 );   //연결에 성공하면 해당하는 토픽으로 subscribe함
                    ...
                    // 익명함수 이용 구독
                    try {
                        mqttAndroidClient.subscribe("otpbox2", 0, new IMqttMessageListener() {
                            @Override
        ...
        /*
        try {
            mqttAndroidClient.subscribe("otpbox", 0, new IMqttMessageListener() {
                @Override
                public void messageArrived(String topic, MqttMessage message) throws Exception {
                    String msg = new String(message.getPayload());
                    Log.e("arrive message : ", msg);
...
*/
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    mqttAndroidClient.publish("otpbox", "jinubb".getBytes(), 0 , false );
                    //버튼을 클릭하면 해당 토픽으로 메시지를 보냄
                } catch (MqttException e) {
                    e.printStackTrace();
                }
            }
        ...
        mqttAndroidClient.setCallback(new MqttCallback() {  //클라이언트의 콜백을 처리하는부분
            ...
            public void messageArrived(String topic, MqttMessage message) throws Exception {    //모든 메시지가 올때 Callback method
                if (topic.equals("otpbox")){     //topic 별로 분기처리하여 작업을 수행할수도있음
                    String msg = new String(message.getPayload());
                    Log.e("arrive message : ", msg);
                }
                else{
                    String msg = new String(message.getPayload());
                    Log.e("another topic : ", topic);
                }
            }
